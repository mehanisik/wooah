...
export const wooahPpl: ProgramTemplate = {
  meta: {
    id: 'wooah-ppl',
    name: 'Wooah! PPL',
    gender: 'unisex',
    ...
    daysPerWeek: 6,
    description:
      'Push/Pull/Legs twice per week with strength-first compounds and hypertrophy accessories.',
    tags: ['hypertrophy', 'strength', 'ppl'],
  },
  days,
  defaultRestDays: [6],
}
